...
anim = animation.FuncAnimation(fig, animate, frames=len(matrix)-1, interval=30, repeat=False)
# anim.save("./simulation_videos/movie.avi", writer=PillowWriter(fps=30))
plt.xlim([0, 203])
plt.ylim([0, 203])
